...
if (typeof window !== 'undefined' && !window.RPSBotAPI) {
    console.error('[kimi_2_5] bot-api.js must be loaded BEFORE this bot');
}
...
const kimi25Bot = {
    ...
    name: 'KIMI 2.5',
    emoji: '🌙',
    avatar: 'js/bots/kimi_2_5/avatar-min.png',
    ...
    modelAuthor: 'Moonshot AI · KIMI K2.5',
    algorithmLabel: 'PV-поиск + quiescence + байес',
    tier: 'easy',
    stars: 1,
    difficultyLabel: 'Лёгкий',
    tags: ['kimi', 'search', 'bayesian', 'neural-patterns', 'champion'],
    ...
    move(gameState) {
        try {
            ...
            console.error('[kimi_2_5] move() failed:', error);
...
if (typeof module !== 'undefined' && module.exports) {
    module.exports = kimi25Bot;
}

if (typeof RPSBotAPI !== 'undefined' && RPSBotAPI.defineBot) {
    RPSBotAPI.defineBot(kimi25Bot);
} else {
    throw new Error('[kimi_2_5] RPSBotAPI is required');
}
