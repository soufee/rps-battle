...
if (typeof window !== 'undefined' && !window.RPSBotAPI) {
    console.error('[gpt_5_5] bot-api.js must be loaded BEFORE this bot');
}
...
const gpt55Bot = (() => {
    ...
    return {
        ...
        name: 'GPT 5.5',
        emoji: '🧠',
        avatar: 'js/bots/gpt_5_5/avatar-min.png',
        ...
        modelAuthor: 'OpenAI · GPT-5.5',
        tier: 'hard',
        stars: 3,
        difficultyLabel: 'Сложный',
        tags: ['gpt', 'openai', 'bayesian', 'tactical', 'flag-pressure'],
        ...
        move(gameState) {
            try {
                ...
                console.error('[gpt_5_5] move() failed:', error);
                return null;
            }
        },
...
if (typeof RPSBotAPI !== 'undefined' && RPSBotAPI.defineBot) {
    RPSBotAPI.defineBot(gpt55Bot);
} else {
    throw new Error('[gpt_5_5] RPSBotAPI is required');
}
