...
if (typeof window !== 'undefined' && !window.RPSBotAPI) {
    console.error('[losenok] bot-api.js must be loaded BEFORE this bot');
}
...
const losenokBot = (() => {
    ...
    function move(gameState) {
        try {
            ...
            console.error('[losenok] move() failed:', e);
            try {
    ...
    return {
        ...
        name: 'Лосёнок',
        emoji: '◇',
        avatar: 'js/bots/losenok/avatar-min.png',
...
if (typeof module !== 'undefined' && module.exports) {
    module.exports = losenokBot;
}

if (typeof RPSBotAPI !== 'undefined' && RPSBotAPI && typeof RPSBotAPI.defineBot === 'function') {
    RPSBotAPI.defineBot(losenokBot);
} else {
    throw new Error('[losenok] RPSBotAPI.defineBot is required (load bot-api.js first)');
}
