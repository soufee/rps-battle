...
if (typeof window !== 'undefined' && !window.RPSBotAPI) {
    console.error('[akulenok] bot-api.js must be loaded BEFORE this bot');
}
...
const akulenokBot = (() => {
    ...
    function move(gameState) {
        try {
            ...
            console.error('[akulenok] move() failed:', e);
            try {
    ...
    return {
        ...
        name: 'Акулёнок',
        emoji: '💠',
        avatar: 'js/bots/akulenok/avatar-min.png',
...
if (typeof module !== 'undefined' && module.exports) {
    module.exports = akulenokBot;
}

if (typeof RPSBotAPI !== 'undefined' && RPSBotAPI && typeof RPSBotAPI.defineBot === 'function') {
    RPSBotAPI.defineBot(akulenokBot);
} else {
    throw new Error('[akulenok] RPSBotAPI.defineBot is required (load bot-api.js first)');
}
