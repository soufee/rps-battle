...
if (typeof window !== 'undefined' && !window.RPSBotAPI) {
    console.error('[bobrenok] bot-api.js must be loaded BEFORE this bot');
}
...
const bobrenokBot = {
    ...
    name: 'Бобрёнок',
    emoji: '⚡',
    avatar: 'js/bots/bobrenok/avatar-min.png',
    ...
    tags: ['search', 'beliefs', 'tactical', 'adaptive'],
    ...
    move(gameState) {
        try {
            ...
            console.error('[bobrenok] move() failed:', error);
            return null;
        }
    },
...
if (typeof module !== 'undefined' && module.exports) {
    module.exports = bobrenokBot;
}

if (typeof RPSBotAPI !== 'undefined' && RPSBotAPI.defineBot) {
    RPSBotAPI.defineBot(bobrenokBot);
} else {
    throw new Error('[bobrenok] RPSBotAPI is required');
}
